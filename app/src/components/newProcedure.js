    ...
    return (
        ...
        <div className="mx-auto max-w-2xl bg-white p-8 rounded-lg shadow">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div>
                    <label htmlFor="nome" className="block mb-2 text-sm font-medium text-black dark:text-slate-300">Nome do Procedimento</label>
                    <input type="text" {...register('name')} className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                    <p className="text-red-500">{errors.name?.message}</p>
                </div>
                <div>
                    <label htmlFor="value" className="block mb-2 text-sm font-medium text-black dark:text-slate-300">Valor do Procedimento</label>
                    <CampoMoeda
                        name="value"
                        placeholder="R$ 0,00"
                ...
                <div>
                    <label htmlFor="observation" className="block mb-2 text-sm font-medium text-black dark:text-slate-300">Observações</label>
